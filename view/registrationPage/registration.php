...
<head>
    ...
    <title>Spender - Регистрация</title>
...
<body>
        <div id="range5">
            ...
            <div class="middle">
                <div class="inner">
                    ...
                    <h2>Регистрация</h2>
                    <form class="form" action="/reg/add/" method="post">
                        <input class="log" type="text" placeholder="Имя" name="login"><br>
                        <i>Не менее трех латинских символов</i>
                        <input class="mail" type="email" placeholder="Почта" name="email">
                        <input class="pass" type="password" placeholder="Пароль" name="pwd1">
                        <input class="pass2" type="password" placeholder="Повторите пароль" name="pwd2"><br>
                        <i>Пароль должен содержать минимум 1 большую и маленькую букву, 1 цифру и длинну от 8 до 15 символов</i>
                        <p><a href="http://www.nusa.zzz.com.ua/">На главную</a></p>
    ...
    <script src="/view/registrationPage/app/check.js"></script>
</body>
</html>